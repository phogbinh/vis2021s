! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).BinaryDecisionTree = e() }(this, (function() {
    "use strict";
    ...
    function s(t, e) {
        ...
        if (!i) {
            if (Array.isArray(t) || (i = function(t, e) { if (t) { if ("string" == typeof t) return r(t, e); var i = Object.prototype.toString.call(t).slice(8, -1); return "Object" === i && t.constructor && (i = t.constructor.name), "Map" === i || "Set" === i ? Array.from(t) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? r(t, e) : void 0 } }(t)) || e && t && "number" == typeof t.length) {
                i && (t = i);
                var a = 0,
                    s = function() {};
                return { s: s, n: function() { return a >= t.length ? { done: !0 } : { done: !1, value: t[a++] } }, e: function(t) { throw t }, f: s }
            }
            throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
        }
        var n, o = !0,
            l = !1;
        return { s: function() { i = i.call(t) }, n: function() { var t = i.next(); return o = t.done, t }, e: function(t) { l = !0, n = t }, f: function() { try { o || null == i.return || i.return() } finally { if (l) throw n } } }
    }
    var n, o, l = (n = [], o = {}, new(function() {
            function t() { e(this, t) }
            return a(t, [{ key: "listenTo", value: function(t, e) { if (-1 === n.indexOf(t)) return console.error("Event: " + t + " is not registered"), !1; var i = o[t].push(e); return function() { return o[t].splice(i - 1, 1), !0 } } }, { key: "register", value: function(t) { return -1 !== n.indexOf(t) ? (console.error("Event: " + t + " has registered"), !1) : (n.push(t), o[t] = [], !0) } }, { key: "emit", value: function(t, e) { return -1 === n.indexOf(t) ? (console.error("Event: " + t + " is not registered"), !1) : (o[t].forEach((function(t) { "function" == typeof t && t(e) })), !0) } }, { key: "remove", value: function(t) { var e = n.indexOf(t); return -1 === e ? (console.error("Event: " + t + " is not registered"), !1) : (n.splice(e, 1), delete o[t], !0) } }]), t
        }())),
        h = function() {
            function i() { e(this, i) }
            return a(i, null, [{ key: "ZENO", value: function(t, e) { var i = .85 * (t - e); return Math.abs(i) < .05 ? e : i + e } }, { key: "FILL_FN", value: function(e, i) { return i || (i = 1), "object" == t(e) && e.target > .5 || "isTarget" === e || "boolean" == typeof e && e ? "rgba(245,23,32," + i + ")" : "rgba(248,210,16," + i + ")" } }, {
                key: "ParseGeometryFromTreeData",
                value: function(t) {
                    var e = d3.layout.tree().separation((function(t, e) { return t.parent, e.parent, 1 })),
                        i = e.nodes(t);
                    return i.forEach((function(t) { return t.samples = +t.samples })), { nodes: i, links: e.links(i) }
                }
            }, {
                key: "arrayShuffle",
                value: function(t) {
                ...
                value: function(t, e) {
                    ...
                    var i, a = [],
                        r = [],
                        n = s(t);
                    try { for (n.s(); !(i = n.n()).done;) { var o = i.value;!0 === e(o) ? a.push(o) : r.push(o) } } catch (t) { n.e(t) } finally { n.f() }
                    return [a, r]
                }
            }, { key: "compileDataForNode", value: function(t, e, i) { var a = []; return e[i].data_rows && (e[i].data_rows.true && (a = a.concat(e[i].data_rows.true)), e[i].data_rows.false && (a = a.concat(e[i].data_rows.false))), a.map((function(e) { return t.find((function(t) { return t.index == e })) })) } }, {
                ...
                value: function(t, e) {
                    ...
                    if (t[e].data_rows) {
                        ...
                        var r = i + a,
                            s = "isTarget";
                        return a > i && (s = "isNotTarget"), { true: i / r, false: a / r, classification: s }
                    }
        ...
        c = function() {
            function t(i) {
                e(this, t), Object.assign(this, i), this.scroll = 0, this.largeTextSize = 26, this.smallTextSize = 22, this.labelVerticalOffset = -this.largeTextSize - 10, this.trainingGroup = this.g.append("g"), this.trainingLine = this.trainingGroup.append("rect").attr("width", 300).attr("height", 1).attr("fill", "#aaaaaa"), this.trainingLabel = this.trainingGroup.append("text").text("訓練資料集").attr("text-anchor", "middle").attr("font-size", 9).attr("y", this.labelVerticalOffset).attr("x", 300), this.testGroup = this.g.append("g").attr("opacity", 0), this.testLine = this.testGroup.append("rect").attr("width", 300).attr("height", 1).attr("fill", "#aaaaaa"), this.testLabel = this.testGroup.append("text").text("測試資料集").attr("text-anchor", "middle").attr("font-size", 9).attr("y", this.labelVerticalOffset).attr("x", 300), this.testOpacity = 0, this.opacityInterpolator = d3.scale.linear().domain([1e5, 100100]).range([0, 1]).clamp(!0), this.results = { train: { isTarget: {}, isNotTarget: {} }, test: { isTarget: {}, isNotTarget: {} } }, this.textNodes = { train: { isTarget: { correct: this.trainingGroup.append("text"), total: this.trainingGroup.append("text") }, isNotTarget: { correct: this.trainingGroup.append("text"), total: this.trainingGroup.append("text") }, accuracy: this.trainingGroup.append("text") }, test: { isTarget: { correct: this.testGroup.append("text"), total: this.testGroup.append("text") }, isNotTarget: { correct: this.testGroup.append("text"), total: this.testGroup.append("text") }, accuracy: this.testGroup.append("text") } }, this.largeTextNodes = [], this.smallTextNodes = [];
                var a = -8;
            ...
            }, { key: "updateNumber", value: function(t, e, i) { this.results[t][e] = i, this.rr = !0 } }, {
                key: "handleScroll",
                value: function(t) {
                    this.scroll = t;
        ...
        d = function() {
            function t(i) {
                ...
                var a = i.el,
                    ...
                    f = n.test_stats,
                    g = i.renderer;
                Object.assign(this, { el: d3.select(a), trainingSection: r, testSection: s, treeData: o, training: d, training_stats: u, test: p, test_stats: f }), this.paddingRight = 20, this.ballRadius = 3, this.ballSpacing = this.ballRadius + 5, this.labelOffset = 30, this.svg = this.el.append("svg"), this.flood = i.flood, this.pathGroup = this.svg.append("g"), this.circleGroup = this.svg.append("g"), this.labelsGroup = this.svg.append("g"), this.hoverGroup = this.svg.append("g"), this.resultsGroup = this.svg.append("g"), this.resultsView = new c({ g: this.resultsGroup, renderer: g }), this.trainingSamples = [], this.testSamples = [], this.splitLabels = [], this.sampleIndex = [], this.tree = h.ParseGeometryFromTreeData(this.treeData), this.trainingSamples = this.setUpAbstractGeometry(this.training, this.training_stats, "train"), this.testSamples = this.setUpAbstractGeometry(this.test, this.test_stats, "test"), this.tree.nodes.forEach(function(t) {
                    ...
                    t.children && (h = n.append("rect").classed("leftHover", !0).attr("x", -60).attr("width", 60).attr("y", .6 * this.labelOffset).attr("height", 60).attr("opacity", 0).on("mouseenter", function() { this.splitID = t.children[0].id, this.rr = !0 }.bind(this)).on("mouseleave", function() { this.splitID = null, this.rr = !0 }.bind(this)), c = n.append("rect").classed("rightHover", !0).attr("x", 0).attr("width", 60).attr("y", .6 * this.labelOffset).attr("height", 60).attr("opacity", 0).on("mouseenter", function() { this.splitID = t.children[1].id, this.rr = !0 }.bind(this)).on("mouseleave", function() { this.splitID = null, this.rr = !0 }.bind(this))), this.splitLabels.push({ node: t, layer: a, overlayLayer: r, hoverLayer: n, leftHover: h, rightHover: c, leftArrow: d, rightArrow: u, leftLine: p, rightLine: f, leftLeaf: g, rightLeaf: y, leftText: o, rightText: l })
            ...
            return a(t, [{
                ...
                value: function(t, e, i) {
                    var a = [],
                        r = t.map(function(t) {
                            ...
                            return r.on("mouseenter", function() { this.sampleID = t.index, this.rr = !0 }.bind(this)).on("mouseleave", function() { this.sampleID = null, this.rr = !0 }.bind(this)).attr("fill", h.FILL_FN(t)).attr("stroke-width", 1).attr("stroke", h.FILL_FN(t)).attr("r", this.ballRadius), a.push(t.index), { groupID: i, attributes: t, waypoints: [], treeCoordinates: [], path: e, circle: r, x: 0, y: 0 }
                        }.bind(this));
                    e.forEach(function(t) {
                        t.data.forEach(function(e) {
                            var i = a.indexOf(e.index);
                            if (i >= 0) {
                                var s = { x: this.tree.nodes[parseInt(t.node)].x, y: this.tree.nodes[parseInt(t.node)].y };
                    ...
                    var s = h.arrayPartition(r, (function(t) { return "isTarget" == t.classification })),
                        n = s[0].length,
                        o = s[1].length,
                        l = 0,
                        c = 0;
                ...
                value: function(t, e, i) {
                    ...
                    var r = 0;
                    t.treeCoordinates.forEach(function(t, e) { r = this.treeScales.x(t.x), a += "L " + this.treeScales.x(t.x) + " " + this.treeScales.y(t.y) + " ", a += "L " + this.treeScales.x(t.x) + " " + (this.treeScales.y(t.y) + this.labelOffset) + " " }.bind(this)), a += "L " + r + " " + this.treeScales.y(1.1) + " ";
                ...
                value: function() {
                    ...
                    this.bounds.width > 850 ? (this.ballRadius = 3, this.ballSpacing = this.ballRadius + 5) : this.bounds.width > 650 ? (this.ballRadius = 2, this.ballSpacing = this.ballRadius + 4) : (this.ballRadius = 1.5, this.ballSpacing = this.ballRadius + 3), this.trainingSamples.forEach(function(t) { t.circle.attr("r", this.ballRadius) }.bind(this)), this.testSamples.forEach(function(t) { t.circle.attr("r", this.ballRadius) }.bind(this)), this.svg.attr("width", this.bounds.width - this.paddingRight).attr("height", this.bounds.height);
                    var e = { x: [0, this.bounds.width - this.paddingRight - 40], y: [.05 * this.bounds.height + this.ballSpacing, .6 * this.bounds.height] };
                    this.treeScales = { x: d3.scale.linear().domain([0, 1]).range(e.x), y: d3.scale.linear().domain([0, 1]).range(e.y) }, this.funnelStart = { x: this.treeScales.x(this.tree.nodes[0].x), y: .05 * this.bounds.height }, this.targetCount = { train: 0, test: 0 }, this.notTargetCount = { train: 0, test: 0 }, this.splitLabels.forEach(function(t) {
                    ...
                    var i = this.el.node().getBoundingClientRect(),
                        ...
                        s = i.y;
                    this.trainingSamples.forEach(function(t) { this.updateSamplePath(t, null, { x: r, y: s }), r - 3 * this.ballRadius < 0 ? (r = a - 3 * this.ballRadius, s += 3 * this.ballRadius) : r -= 3 * this.ballRadius }.bind(this));
                    var n = a + 3 * this.ballRadius,
                        o = i.y;
                    this.testSamples.forEach(function(t) { this.updateSamplePath(t, null, { x: n, y: o }), n + 3 * this.ballRadius > i.width ? (n = a + 3 * this.ballRadius, o += 3 * this.ballRadius) : n += 3 * this.ballRadius }.bind(this));
                    ...
                    this.trainingSamples.forEach((function(t, e) {
                        ...
                        var i = d + e * g,
                            a = d + p;
                        t.scrollExtent = [i, a], t.scrollDuration = p
                    })), this.resultsView.handleResize({ width: this.bounds.width, baseline: { training: this.baseline.training + this.ballSpacing, test: this.baseline.test + this.ballSpacing }, scrollExtent: { training: [l, c], test: [d, u] } }), this.rr = !0
                }
            }, {
                ...
                key: "handleScroll",
                value: function(t) {
                    var e = { train: { isTarget: { correct: 0, total: 0 }, isNotTarget: { correct: 0, total: 0 } }, test: { isTarget: { correct: 0, total: 0 }, isNotTarget: { correct: 0, total: 0 } } };
                    this.trainingSamples.forEach(function(i) { this.rr = this.updatePointPosition(i, t) || this.rr, i.done && (e.train[i.classification].total++, i.correctlyClassified && e.train[i.classification].correct++) }.bind(this)), this.testSamples.forEach(function(i) { this.rr = this.updatePointPosition(i, t) || this.rr, i.done && (e.test[i.classification].total++, i.correctlyClassified && e.test[i.classification].correct++) }.bind(this)), ["train", "test"].forEach(function(t) {
                        ["isTarget", "isNotTarget"].forEach(function(i) { e[t][i].total > 0 ? e[t][i].percent = Math.round(e[t][i].correct / e[t][i].total * 100) : e[t][i].percent = 0, this.resultsView.updateNumber(t, i, e[t][i]) }.bind(this))
                    }.bind(this))
                }
            }, { key: "renderSamples", value: function(t) { t.rr && t.circle.attr("cx", t.x).attr("cy", t.y), this.sampleID ? (this.sampleID == t.attributes.index && t.path.attr("opacity") <= 0 && t.path.attr("opacity", 1).attr("style", "display: initial"), this.sampleID != t.attributes.index && t.path.attr("opacity") > 0 && t.path.attr("opacity", 0).attr("style", "display: none")) : this.splitID && (t.waypoints.indexOf(this.splitID) >= 0 ? t.path.attr("opacity", .1).attr("style", "display: initial") : t.path.attr("opacity", 0).attr("style", "display: none")), this.sampleID || this.splitID || t.path.attr("opacity", 0).attr("style", "display: none") } }, { key: "render", value: function() { this.trainingSamples.forEach(function(t) { this.renderSamples(t) }.bind(this)), this.testSamples.forEach(function(t) { this.renderSamples(t) }.bind(this)), this.splitLabels.forEach(function(t) { this.splitID ? t.node.children && (this.splitID == t.node.children[0].id ? (t.leftText.attr("style", "display: block;"), t.leftLine.attr("stroke", "#333333").attr("stroke-width", 2)) : (t.leftText.attr("style", "display: none;"), t.leftLine.attr("stroke", "#bbbbbb").attr("stroke-width", 1)), this.splitID == t.node.children[1].id ? (t.rightText.attr("style", "display: block;"), t.rightLine.attr("stroke", "#333333").attr("stroke-width", 2)) : (t.rightText.attr("style", "display: none;"), t.rightLine.attr("stroke", "#bbbbbb").attr("stroke-width", 1))) : (t.rightText.attr("style", "display: none;"), t.leftText.attr("style", "display: none;"), t.leftLine.attr("stroke", "#bbbbbb").attr("stroke-width", 1), t.rightLine.attr("stroke", "#bbbbbb").attr("stroke-width", 1)) }.bind(this)) } }]), t
        }(),
        u = function(t, e) {
            var i, a = s(e);
            try {
        ...
        p = function() {
            function t() { e(this, t), this.views = [] }
            return a(t, [{ key: "renderScene", value: function() { this.views.forEach((function(t, e) { t.rr && (t.rr = !1, t.render()) })) } }]), t
        }();
    return function() {
        function t(i) {
            e(this, t);
        ...
        return a(t, [{ key: "setDataFromObject", value: function(t) { this.data = t } }, {
            key: "setDataFromJson",
            value: function(t, e) {
                var i = new XMLHttpRequest,
                    a = this;
                if ("function" != typeof e) return new Promise((function(e, r) { i.onload = function() { a.data = JSON.parse(i.responseText), e() }, i.open("GET", t), i.send() }));
                i.onload = function() { a.data = JSON.parse(i.responseText), e() }, i.open("GET", t), i.send()
            }
        }, {
            key: "install",
            value: function() {
                ...
                })), l.register("__global_resize"), window.addEventListener("resize", (function() { l.emit("__global_resize") })), new d({ el: this.el, trainingSection: this.trainingSection, testSection: this.testSection, allTreeData: { treeData: i, training: a, training_stats: r, test: s, test_stats: n }, renderer: t, flood: this._flood }), this.renderer = t, this.isInstall = !0
            }
        }, {
            key: "play",
            value: function() {
                ...
                var t, e = !1,
                    i = this;
                return t = window.requestAnimationFrame((function a() { e || (t = window.requestAnimationFrame(a), i.renderer.renderScene()) })),
                    function() { e = !0, window.cancelAnimationFrame(t) }
            }
        }]), t
    }()
}));