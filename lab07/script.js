...
window.addEventListener('load', function() {
    loadByPathAndAnimateNameCharacter('./uni9673_FZSJSK--GBK1-0.svg', '#chen');
    loadByPathAndAnimateNameCharacter('./uni98A8_FZSJSK--GBK1-0.svg', '#feng');
    loadByPathAndAnimateNameCharacter('./uni5E73_FZSJSK--GBK1-0.svg', '#ping');
